...
public class ClassCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String CommandLabel, String[] args) {
		...
		} else if (cooldown.containsKey(p.getName())) {
				long secondsLeft = ((cooldown.get(p.getName())/1000) + cooldownTime) - (System.currentTimeMillis()/1000);
				
				if (secondsLeft > 0) { 
					p.sendMessage(prefix + ChatColor.RED + "You must wait another " + ChatColor.AQUA + secondsLeft/3600 + ChatColor.RED + " hours before changing your class again!");
					return true;  
				}
