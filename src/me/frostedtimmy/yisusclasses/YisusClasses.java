...
import me.frostedtimmy.yisusclasses.events.EnchanterItemsHeld;
...
public class YisusClasses extends JavaPlugin {
	...
	public void onEnable() {
		...
		this.getServer().getPluginManager().registerEvents(new EnchanterItemsHeld(), this);
		new ClassInvClick(this);
		
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		
		Bukkit.getConsoleSender().sendMessage("[YisusClasses] " + ChatColor.GREEN + "Poggers! Enabled: " + ChatColor.BLUE + "It took " + ChatColor.GOLD + duration + "ms");
